...
public static class DeferredVsImmediateQueries
{
    ...
    public static IEnumerable<Person> Deferred_HighSalaryInAylaton() => _persons.Where(p => p.Salary > 100000 && p.City == "Aylaton");
    ...
    public static List<Person> Immediate_HighSalaryInAylaton() => _persons.Where(p => p.Salary > 100000 && p.City == "Aylaton").ToList();
}